classdef sdd_dots_gui < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        PsfInputLabel matlab.ui.control.Label
        PsfInput matlab.ui.control.NumericEditField
    ...
    methods (Access = private)
        ...
        function RunButtonPushed(app, ~)
            ...
            try
                dnarec_skel(app.PathInput.Value, sets);
            catch ME
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create PsfInput
            app.PsfInputLabel = uilabel(app.UIFigure);
            app.PsfInputLabel.Position = [app.margin+app.paddingW+app.thirdWidth ...
                app.height-app.margin-app.paddingH-2*app.buttonHeight ...
                app.thirdWidth ...
                app.buttonHeight];
            app.PsfInputLabel.Text = 'Width of LoG filter (nm)';
            app.PsfInput = uieditfield(app.UIFigure, 'numeric');
            app.PsfInput.Position = [app.margin+app.paddingW+app.thirdWidth ...
                app.height-app.margin-app.paddingH-3*app.buttonHeight ...
                app.thirdWidth ...
                app.buttonHeight];
            app.PsfInput.Value = app.psfInputDefault;
