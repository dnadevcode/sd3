function output = dna_process_folder(experiment, functions, actions, sets)
  ...
  for i = 1:numel(images)
    ...
    % Segment image
    [movies, ~, optics, lengthLims, molScoreLim, widthLims, bgPixels] = functions.img_segment(cleanImages, imageNames{i}, i, runNo);

    % Extract barcodes
    [barcodes, dotScoreLim] = functions.bc_extract(movies, optics, lengthLims, i, runNo, bgPixels);
